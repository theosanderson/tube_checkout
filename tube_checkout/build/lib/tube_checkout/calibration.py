...
calibration_point = tube_mover.get_uncalibrated_point(rack.wells()[0].top())
...
def update_pos():
    ...
    offset = pos - calibration_point
    pos_txt.set_text(("reverse","Current position: X: {} Y: {} Z: {} . Offset  X: {} Y: {} Z: {} ".format(round(pos.x,2),round(pos.y,2),round(pos.z,2),round(offset.x,2),round(offset.y,2),round(offset.z,2)) ))
...
def save_offset():
    ...
    offset = cur_pos - calibration_point
